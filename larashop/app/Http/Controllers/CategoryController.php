...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('categories.create')->with('status', 'Category berhasil dibuat');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('categories.edit', ['id' => $id])->with('status', 'Categori Berhasil di Ubah');;
    }
    ...
    ->with('status', 'Category berhasil di tambah di trash');
    }
